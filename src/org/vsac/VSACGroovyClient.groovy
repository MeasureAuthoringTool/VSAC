...
class VSACGroovyClient {
	 ...
	 * Constructor
	 * */
	VSACGroovyClient(String proxyServer, int proxyPort,String vsacServerURL , String vsacServiceURL , String vsacReteriveServiceURL, String profileServiceURL, String versionServiceURL, String drcVsacUrl){
	 ...
	 * 
	 * */
	VSACResponseResult getDirectReferenceCode(String codeURLString, String serviceTicket){
		VSACResponseResult vsacResponseResult = new VSACResponseResult()
		if(serviceTicket == null) {
			return null
		}
		try {
			...
			method.setQueryString([new NameValuePair("ticket", serviceTicket), new NameValuePair("resultFormat", "xml"), new NameValuePair("resultSet", "standard")].toArray(new NameValuePair[3]))
	 ...
	 * @return VSACResponseResult
	 */
	VSACResponseResult getAllPrograms(){
		VSACResponseResult vsacResponseResult = new VSACResponseResult()
	 ...
	 * @return VSACResponseResult
	 */
	VSACResponseResult getReleasesOfProgram(String program){
	...
	VSACResponseResult getMultipleValueSetsResponseByOIDAndRelease(String oid, String release, String serviceTicket) {
		VSACResponseResult vsacResponseResult = new VSACResponseResult()
		if(serviceTicket == null) {
			return null
		}
	...
	VSACResponseResult getLatestProfileOfProgram(String programName){
